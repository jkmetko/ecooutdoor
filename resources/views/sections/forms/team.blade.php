<section class="page-section page-section__dark" id="section-team" style="display: block">
    <div class="container">
                    ...
                    @foreach($team as $member)
                        <div class="item">
                            ...
                            <div class="person-info">
                                <a href="{{ url('admin/delete_member/'.$member->id) }}" class="fa fa-close" style="position: absolute; top: -30px; right: 20px; cursor: pointer" data-toggle="tooltip" title="Odstrániť"></a>
